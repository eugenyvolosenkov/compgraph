// SmallPT.cpp : Defines the entry point for the console application.
//
...
#include <stdio.h>  
#include"omp.h"//        Remove "-fopenmp" for g++ version < 4.2
#include <iostream>
...
Vec radiance(const Ray &r, int depth, unsigned short *Xi){
  ...
  if (obj.refl == DIFF){                  // Ideal DIFFUSE reflection
    double r1=2*PI*(rand() % (int)Xi), r2= (rand() % (int)Xi), r2s=sqrt(r2);
...
spheres[8]=Sphere(600, Vec(50,681.6-.27,81.6),Vec(12,12,12),  Vec(), DIFF);//Lite
  int w=320, h=480, samps = 1000/4; // # samples
